...
SELECT pg_terminate_backend(pid) FROM pg_stat_activity WHERE user LIKE '%'"
  ...
  tag gid: 'V-233601'
  tag rid: 'SV-233601r998206_rule'
  tag stig_id: 'CD12-00-010100'
  tag fix_id: 'F-36760r998205_fix'
